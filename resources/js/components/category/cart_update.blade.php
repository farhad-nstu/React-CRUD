                    ...
                    <div class="col-lg-4">
                        <div class="cart-summary">
                            ...
                            <div class="form-group">
                                <button class="btn btn-sm btn-info" id="cashonDeliveryBtn">Cash on Delivery</button>
                              </div><br>
                              <div class="form-group">
                                  <button class="btn btn-sm btn-info" id="onlinePaymentBtn">Online Payment</button>
                        ...
                        <table class="table table-totals">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <input type="hidden" class="form-control" id="pay_amount"  name="amount" required="" value="{{ $total_pcire  }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                      <input type="text" name="desc" class="form-control" id="desc" placeholder="Products Name Payment">
                                    </div>
                                  </div>
                                @endif
                            </tbody>
...
@section('script')
    ...
    //     var payVal = document.getElementById('onlinePayment').value;
    //     if(payVal){
    //         @php
